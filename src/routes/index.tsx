    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden border-b border-border bg-background">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
          <Reveal>
            <h1 className="text-display text-4xl sm:text-5xl lg:text-[3.6rem]">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              <Button asChild size="lg" variant="outline" className="rounded-full">
                <Link to="/jobs" search={defaultJobSearch}>Find Teaching Jobs</Link>
              </Button>
            </div>
          ...
          <Reveal>
            <div className="flex flex-wrap items-end justify-between gap-6">
              ...
              <Button asChild variant="ghost">
                <Link to="/jobs" search={defaultJobSearch}>
